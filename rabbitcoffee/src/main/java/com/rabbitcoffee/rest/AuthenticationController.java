...
import com.rabbitcoffee.model.TokenState;
import com.rabbitcoffee.security.TokenHelper;
import com.rabbitcoffee.security.auth.JwtAuthenticationRequest;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> createAuthenticationToken(
        ...
        // Return the token
        return ResponseEntity.ok(new TokenState(jws, expiresIn));
    }
    ...
    public ResponseEntity<?> refreshAuthenticationToken(
        ...
        if (authToken != null && principal != null) {
            ...
            TokenState userTokenState = new TokenState();
